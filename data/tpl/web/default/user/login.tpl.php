			...
			<div class="panel-body">
				<form action="" method="post" role="form" id="form1" onsubmit="return formcheck();">
					...
					<div class="form-group input-group">
						...
						<input name="verify" type="text" class="form-control input-lg" style="width:300px;" placeholder="请输入验证码">
						<img id="imgverify" style="height:46px;" /> <a href="javascript:;" id="toggle">看不清？换一张</a>
					</div>
					<?php  } ?>
