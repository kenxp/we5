...
<script id='tpl_main' type='text/html'>
 <div class="balance_img"><i class="fa fa-cny"></i></div>
    ...
    <div class="balance_sub balance_sub1 <%if !cansettle%>disabled<%/if%>" data-type="0"><?php  echo $this->set['texts']['widthdraw']?>到余额</div>
    <?php  } ?>
    
    <div class="balance_sub balance_sub2 <%if !cansettle%>disabled<%/if%>"  data-type="1"><?php  echo $this->set['texts']['withdraw']?>到微信</div>
